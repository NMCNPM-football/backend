...
var file_match_svc_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xbe, 0x06, 0x0a, 0x0c, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76,
...
var file_match_svc_proto_depIdxs = []int32{
	...
	7, // 8: proto.MatchService.CreateMatchCalendar:output_type -> proto.MatchCalendarRequest
	8, // 9: proto.MatchService.UpdateMatchCalendar:output_type -> proto.MatchCalendarResponse
	9, // 10: proto.MatchService.CreateProgressScore:output_type -> SuccessMessageResponse
	9, // 11: proto.MatchService.CreateProgressCard:output_type -> SuccessMessageResponse
	9, // 12: proto.MatchService.CreateMatchResult:output_type -> SuccessMessageResponse
	9, // 13: proto.MatchService.CreateAllMatchResults:output_type -> SuccessMessageResponse
	9, // 14: proto.MatchService.CreateGoalType:output_type -> SuccessMessageResponse
	9, // 15: proto.MatchService.CreateCardType:output_type -> SuccessMessageResponse
