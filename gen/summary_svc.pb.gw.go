...
func RegisterSummaryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SummaryServiceServer) error {
	...
	mux.Handle("POST", pattern_SummaryService_CreateSummary_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.SummaryService/CreateSummary", runtime.WithHTTPPathPattern("/summary"))
		if err != nil {
...
func RegisterSummaryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SummaryServiceClient) error {
	...
	mux.Handle("POST", pattern_SummaryService_CreateSummary_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.SummaryService/CreateSummary", runtime.WithHTTPPathPattern("/summary"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SummaryService_CreateSummary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"summary"}, ""))
)
